...
public class SkipList <E> implements List<E> {
	...
	public void add(int index, E element) {
		...
		for (Node <E> x = head; x != null; x = x.down, currentLevel --){
			//			System.out.println("Pos:" + pos + " CurrentLevel: "+ currentLevel);//debug
			//			System.out.println("x == null: " + (x == null));//debug
			//			System.out.println("x.down == null: " + (x.down == null));//debug
			...
			if (currentLevel > lvl) 
				...
				//System.out.println("Else: Insert at that level");//debug
			...
			//			System.out.println("At the end: Pos:" + pos + " CurrentLevel: "+ currentLevel);//debug
			//			System.out.println("At the end: x == null: " + (x == null));//debug
			//			System.out.println("At the end: x.down == null: " + (x.down == null));//debug
		}
		size ++;
	}
